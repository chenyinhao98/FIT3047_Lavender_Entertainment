...
<div id="wrapper" style="width:100%;">
    ...
    <ul class="navbar-nav sidebar sidebar-dark accordion" style=" background-image:linear-gradient(180deg, #a298fc 10%, #6f47bd 100%)" id="accordionSidebar">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed services-2 bold-text" href="#" data-toggle="collapse" data-target="#collapseTwo"
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="cards.html">View All Venues</a>
                    <a class="collapse-item" href="cards.html">Edit Venue</a>
                    <a class="collapse-item" href="buttons.html">Add New Venues</a>
                </div>
            </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div id="collapseSuppliers" class="collapse" aria-labelledby="headingSuppliers"
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="">View All Suppliers</a>
                    <a class="collapse-item" href="utilities-border.html">Edit Supplier</a>
                    <a class="collapse-item" href="utilities-animation.html">Add New Supplier</a>
                </div>
            </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div id="collapseTalent" class="collapse" aria-labelledby="headingTalent"
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="utilities-color.html">View All Talent</a>
                    <a class="collapse-item" href="utilities-border.html">Edit Talent</a>
                    <a class="collapse-item" href="utilities-animation.html">Add New Talent</a>
                </div>
            </div>
        </li>
