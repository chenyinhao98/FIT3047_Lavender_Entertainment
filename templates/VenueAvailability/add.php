        ...
        <li class="nav-item active">
            ...
            <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a style="color:#a298fc;" class="collapse-item active">Add Venue Availability</a>                </div>
            </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div id="collapseTalent" class="collapse" aria-labelledby="headingTalent"
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <?= $this->Html->link(__('Add Talent Availability'), ['controller'=>'TalentAvailability','action' => 'add'], ['class' => 'collapse-item']) ?></div>
            </div>
        </li>
            ...
            <div class="suppliers form content">
                ...
                <fieldset style="padding-left: 5%; padding-right:5%">
                    <h1 class="h3 mb-0 text-black-50" style="font-family: Poppins, Arial, sans-serif; font-weight: bold;">
                        <legend><?= __('Add Venue Availability') ?></legend></h1><br>
                    <?php
