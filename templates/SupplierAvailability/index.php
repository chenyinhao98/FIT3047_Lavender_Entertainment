...
<div id="wrapper" style="width:100%;">
    ...
    <ul class="navbar-nav sidebar sidebar-dark accordion" style=" background-image:linear-gradient(180deg, #a298fc 10%, #6f47bd 100%)" id="accordionSidebar">
        ...
        <li class="nav-item active">
            ...
            <div id="collapseSuppliers" class="collapse show" aria-labelledby="headingSuppliers"
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a style="color:#a298fc;" class="collapse-item active">Supplier Availability</a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-black-50" style="font-family: Poppins, Arial, sans-serif; font-weight: bold; padding-left: 1%;" ><?= __('Supplier Availability') ?></h3></h1>
            </div>
            <div class="venues index content">
                <div class="table-responsive" style="padding-left: 1%; padding-right: 1%; font-size: 85%">
