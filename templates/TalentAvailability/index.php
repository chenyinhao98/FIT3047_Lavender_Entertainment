        ...
        <li class="nav-item active">
            ...
            <div id="collapseTalent" class="collapse show" aria-labelledby="headingTalent"
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a style="color:#a298fc;" class="collapse-item active">Talent Availability</a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-black-50" style="font-family: Poppins, Arial, sans-serif; font-weight: bold; padding-left: 1%;" ><?= __('Talent Availability') ?></h3></h1>
            </div>
