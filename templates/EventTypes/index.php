        ...
        <li class="nav-item">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <?= $this->Html->link(__('View All Venue'), ['controller'=>'Venues','action' => 'index'], ['class' => 'collapse-item']) ?>
        ...
        <li class="nav-item active">
            ...
            <div id="collapseEventTypes" class="collapse show" aria-labelledby="headingEventTypes"
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a style="color:#a298fc;" class="collapse-item active">View All Event Types</a>
