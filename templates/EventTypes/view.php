                ...
                <div class="table-responsive">
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="actions">
                                <?= $this->Html->link(__('View'), ['controller' => 'Suppliers', 'action' => 'view', $suppliers->supplierID]) ?>
                                <?= $this->Html->link(__('Edit'), ['controller' => 'Suppliers', 'action' => 'edit', $suppliers->supplierID]) ?>
                                <?= $this->Form->postLink(__('Delete'), ['controller' => 'Suppliers', 'action' => 'delete', $suppliers->supplierID], ['confirm' => __('Are you sure you want to delete # {0}?', $suppliers->supplierID)]) ?>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </table>
                ...
                <div class="table-responsive">
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="actions">
                                <?= $this->Html->link(__('View'), ['controller' => 'Talents', 'action' => 'view', $talents->talentID]) ?>
                                <?= $this->Html->link(__('Edit'), ['controller' => 'Talents', 'action' => 'edit', $talents->talentID]) ?>
                                <?= $this->Form->postLink(__('Delete'), ['controller' => 'Talents', 'action' => 'delete', $talents->talentID], ['confirm' => __('Are you sure you want to delete # {0}?', $talents->talentID)]) ?>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </table>
                ...
                <div class="table-responsive">
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="actions">
                                <?= $this->Html->link(__('View'), ['controller' => 'Venues', 'action' => 'view', $venues->venueID]) ?>
                                <?= $this->Html->link(__('Edit'), ['controller' => 'Venues', 'action' => 'edit', $venues->venueID]) ?>
                                <?= $this->Form->postLink(__('Delete'), ['controller' => 'Venues', 'action' => 'delete', $venues->venueID], ['confirm' => __('Are you sure you want to delete # {0}?', $venues->venueID)]) ?>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </table>
                ...
                <div class="table-responsive">
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="actions">
                                <?= $this->Html->link(__('View'), ['controller' => 'Events', 'action' => 'view', $events->eventID]) ?>
                                <?= $this->Html->link(__('Edit'), ['controller' => 'Events', 'action' => 'edit', $events->eventID]) ?>
                                <?= $this->Form->postLink(__('Delete'), ['controller' => 'Events', 'action' => 'delete', $events->eventID], ['confirm' => __('Are you sure you want to delete # {0}?', $events->eventID)]) ?>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </table>
